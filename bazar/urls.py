...
from bazar.views import AllListingsView, RegisterView, ProfileView, SearchListView, ListingCreateView, ListingUpdateView, \
    ListingDetailView, ListingDeleteView, CategoryListView, CityListView, CityCategoryListView
